Public Class Penyewa
    ...
    Private Sub ReloadDataTableDatabase()
        DataGridPenyewa.DataSource = Home.DataPenyewa.GetDataKoleksiDatabase()
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim selectedPenyewa As List(Of String) = Home.DataPenyewa.GetDataKoleksiByIDDatabase(SelectedTablePenyewa)
